...
index = {"Create_Data": "00_prepare_transaction_data.ipynb",
         ...
         "Transactional_Data": "00_prepare_transaction_data.ipynb",
         "create_labelled_data": "01_label_data.ipynb",
         "fix_error_in_account_info_dataset": "01_label_data.ipynb",
         "label_accounts": "01_label_data.ipynb",
         "label_customers": "01_label_data.ipynb",
         "merge_label_with_main_data": "01_label_data.ipynb"}
...
modules = ["preprocess/prepare_transaction_data.py",
           ...
           "model/classifier.py",
           "preprocess/prepare_transaction_data.py",
           "preprocess/label_data.py",
           "preprocess/extract_features.py",
           "model/train_test_split.py",
           "model/classifier.py"]
